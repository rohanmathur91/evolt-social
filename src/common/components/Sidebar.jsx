...
export const Sidebar = () => {
  ...
  return (
    <aside className="sticky bottom-0 left-0 right-0 z-[2] md:top-[6.2rem] md:left-aside md:ml-auto md:w-[16rem] md:py-2 md:h-[33rem] md:rounded-lg md:border dark:border-gray-700 bg-white shadow-md md:shadow-none dark:bg-gray-900 border-t rounded-none">
